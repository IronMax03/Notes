...
\begin{tabular}{L L}
    ...
    Proportion & A ratio that compares a part to the whole population.\\
\end{tabular}
...
\begin{theorem}[Inclusion-exclusion principle]
  ...
  $\mathbb{P}(\bigcup_{i=1}^n A_i) = \sum_{i=1}^n \mathbb{P}(A_i) - \sum_{1 \leq i < j \leq n} \mathbb{P}(A_i \cap A_j) + \sum_{1 \leq i < j < k \leq n} \mathbb{P}(A_i \cap A_j \cap A_k) - \cdots + (-1)^{n+1} \mathbb{P}(A_1 \cap A_2 \cap \cdots \cap A_n)$
\end{theorem}
