...
\begin{tabular}{>{\ttfamily}l l}
    ...
    .union(lst)                 & add all elements form \texttt{lst}\\
...
Let \texttt{e} be regular expresion and \texttt{s} and \texttt{s2} be a strings.
\begin{tabular}{>{\small\ttfamily}l l}
    ...
    Match Object            & A Match Object is an object containing\\
                            ...
                            & \small{Can acte as a boolean that is true if not empty.}\\
\end{tabular}
...
(?P=name) & Backreference to the named group in the pattern.\\
	\texttt{\textbackslash 1}, \texttt{\textbackslash 2} & In replacement: refer to groups 1, 2 (works in \texttt{re.sub}).\\
	\texttt{\textbackslash g<name>} & In replacement: recommended form for numeric/named groups.\\
\end{tabular}
