...
\begin{tabular}{C L}
    ...
    chmod flag file -u tom  & Change the permissions of a file for user \texttt{tom}. \\
...
\begin{tabular}{C L}
    ...
    journalctl -n 100 -u service & View the last 100 log entries for a specific service. \\
