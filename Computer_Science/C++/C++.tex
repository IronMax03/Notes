...
\begin{tabular}{C L}
    ...
    calloc(n, size)           & Allocate memory for an array of \texttt{n} elements of \texttt{size} bytes each, initialized to zero.\\
    realloc(ptr, size)        & Reallocate memory to a new size.\\
    free(obj)                 & dynamically de-allocate the memory allocated with \texttt{malloc}.\\
\end{tabular}
