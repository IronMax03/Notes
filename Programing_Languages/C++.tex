...
float(var)              & Convert a primitive data type var to float.\\
double(var)             & Convert a primitive data type var to double.\\
static\_cast$<$t$>$(var)& Convert \textbf{var} to the type \textbf{t}.\\
...
sizeof(var)             & return the number of bytes used by the\\
                        & variable. \textbf{sizeof} is a compile-time operator.\\
